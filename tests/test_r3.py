...
class TestR3(unittest.TestCase):
    ...
    def test_truediv01(self):
        self.assertIsInstance(self.a / 3, R3)

    def test_truediv02(self):
        self.assertEqual(R3ApproxMatcher(self.a / 1), self.a)

    def test_truediv03(self):
        self.assertEqual(R3ApproxMatcher(self.a / 2),
                         R3(0.5, 1.0, 1.5))

    def test_truediv04(self):
        self.assertEqual(R3ApproxMatcher(self.a / 2 + self.a / 2), self.a)
    ...
    def test_length01(self):
        self.assertEqual(R3(0.0, 0.0, 0.0).length(), 0)

    def test_length02(self):
        self.assertEqual(R3(1.0, 0.0, 0.0).length(), 1)

    def test_length03(self):
        self.assertEqual(self.a.length(), sqrt(14))

    def test_is_inside_circle01(self):
        self.assertFalse(self.a.is_inside_circle(2))

    def test_is_inside_circle02(self):
        self.assertTrue(self.a.is_inside_circle(sqrt(5)))

    def test_is_inside_circle03(self):
        self.assertTrue(self.a.is_inside_circle(3))
